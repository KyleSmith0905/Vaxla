...
import { d as defineCommand, e as legacyRootDirArgs, l as logLevelArgs, c as cwdArgs, a as logger, g as colors } from '../shared/nuxi.DCVnYqfZ.mjs';
import 'node:tty';
import { r as readPackageJSON } from '../shared/nuxi.wIrae1ai.mjs';
import { l as loadKit } from '../shared/nuxi.BxIDvNqq.mjs';
import { c as cleanupNuxtDirs, n as nuxtVersionToGitIdentifier } from '../shared/nuxi.2PplrG5f.mjs';
import { g as getPackageManagerVersion } from '../shared/nuxi.BSm0_9Hr.mjs';
import { r as resolve } from '../shared/nuxi.Do0aYBCO.mjs';
import { d as detectPackageManager, a as dedupeDependencies, b as addDependency } from '../shared/nuxi.DigSKSZu.mjs';
import 'node:crypto';
import 'node:path';
import 'node:util';
import 'node:url';
