...
export type VaxlaConfig = {
  ...
  name?: string;
  /** The default port to use for the project. */
  port?: number;
  /** Links to external websites on the sidebar, such as the documentation or the project's website. */
  ...
  >;
  /** Packages to run and their configurations, such as `web`, `admin`, and `api`. */
  packages: Record<
    string,
    {
