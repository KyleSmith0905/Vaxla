...
export const crossPlatformSpawn = (command: string, options: SpawnOptionsWithoutStdio) => {
...
export const spawnWrapper = (command: string, options?: {cwd?: string, signal?: AbortSignal}): ChildProcessWithoutNullStreams => {
